...
PrimeFaces.widget.TabView = PrimeFaces.widget.BaseWidget.extend({
    ...
    enhanceMarkup: function() {
        this.jq.addClass('ui-tabs ui-widget ui-widget-content ui-corner-all ui-hidden-container')
        ...
        this.jq.addClass('ui-tabs-' + this.cfg.orientation);
               
        this.jq.children('div').addClass('ui-tabs-panels').children().addClass('ui-tabs-panel ui-widget-content ui-corner-bottom');
        
        this.jq.find('> ul.ui-tabs-nav > li').eq(this.cfg.activeIndex).addClass('ui-tabs-selected ui-state-active');
        this.jq.find('> div.ui-tabs-panels > div.ui-tabs-panel:not(:eq(' + this.cfg.activeIndex + '))').addClass('ui-helper-hidden');
    }

});

/**
 * jQuery Plugin for TabView Widget
 */
(function( $ ) {
  ...
  $.fn.tabview = function(options) {
      ...
      return this.each(function() {
         ...
         new PrimeFaces.widget.TabView(cfg);
      });
  };
